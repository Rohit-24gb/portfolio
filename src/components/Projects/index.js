    ...
    return (
        <Container id="projects">
            <Wrapper>
                ...
                <Desc>I have worked on wide range of projects. From Web apps to Android apps. Here are some of my projects.
                </Desc>
                <ToggleButtonGroup>
                    {toggle === "all" ? (
                    ...
                    <Divider />{toggle === "android app" ? (
                        <ToggleButton active onClick={() => setToggle("android app")}>ANDROID APP'S</ToggleButton>
                    ) : (
                        <ToggleButton value="all" onClick={() => setToggle("android app")}> ANDROID APP'S </ToggleButton>
                    )}
                    ...
                    {toggle === "machine learning" ? (
                        ...
                        <ToggleButton value="all" onClick={() => setToggle("machine learning")}> MACHINE LEARNING </ToggleButton>
                    )}
                </ToggleButtonGroup>
